...
class InterviewStepDetails extends AdoptionStepDetails {
  final DateTime? scheduledAt;

  const InterviewStepDetails({
    required super.id,
    required super.type,
  ...
  factory InterviewStepDetails.fromJson(Map<String, dynamic> json) {
    return InterviewStepDetails(
      id: json['id'] as int,
